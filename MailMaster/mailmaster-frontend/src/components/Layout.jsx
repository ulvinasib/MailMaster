...
// import { Mail, Home, Inbox, Zap, BarChart3, Settings, LogOut,UserPlus,Users,User,Sparkles, Copyleft} from 'lucide-react';
...
//     { name: "Pipeline CRM", href: "/pipeline-crm", icon: BarChart3 },
...
//   return (
//     <div className="flex h-screen bg-[#0F1115] text-slate-200 antialiased">
//       {/* Sidebar - Using a deep obsidian blur effect */}
//       <aside className="w-72 bg-[#161920]/80 backdrop-blur-xl border-r border-white/5 flex flex-col relative z-10">
        
//         {/* Logo Section - High contrast and glowing */}
//         <div className="h-20 flex items-center gap-4 px-8">
...
//             <div className="relative w-10 h-10 bg-[#1e222c] border border-white/10 rounded-xl flex items-center justify-center shadow-2xl">
//               <Mail className="w-5 h-5 text-indigo-400" />
//             </div>
//           </div>
//           <div>
//             <h1 className="text-sm font-bold tracking-widest uppercase bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent">
//               MailMaster
//             </h1>
...
//               </span>
//               <p className="text-[10px] font-medium text-indigo-400/80 uppercase tracking-tighter">AI Engine Active</p>
//             </div>
//           </div>
//         </div>

//         {/* Navigation - With glass pills and glowing indicators */}
...
//                 key={item.name}
//                 onClick={() => navigate(item.href)}
//                 className={`w-full group relative flex items-center gap-3.5 px-4 py-3 rounded-xl font-medium transition-all duration-300 ${
//                   active
...
//                 {/* AI Badge */}
//                 {isAI && (
//                   <span className="ml-auto text-[10px] bg-purple-500/20 text-purple-300 px-2 py-0.5 rounded-full border border-purple-500/30">
//                     Pro
//                   </span>
//                 )}
//               </button>
...
//         {/* User Profile - Frosted glass footer */}
...
//                   </div>
//                 </div>
//                 <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-emerald-500 border-2 border-[#161920] rounded-full"></div>
//               </div>
//               <div className="flex-1 min-w-0">
//                 <p className="text-sm font-bold text-white truncate leading-none">
//                   {user?.email?.split('@')[0] || 'Modern User'}
//                 </p>
...
//             <button
//               onClick={handleSignOut}
//               className="w-full group flex items-center justify-center gap-2 px-4 py-2.5 text-xs font-bold text-slate-400 hover:text-white bg-white/5 hover:bg-red-500/10 border border-white/5 hover:border-red-500/20 rounded-xl transition-all duration-300"
//             >
...
//       {/* Main Content Area - Clean contrast */}
//       <main className="flex-1 overflow-y-auto bg-[#0F1115] relative">
//         {/* Top gradient blob for "Depth" */}
